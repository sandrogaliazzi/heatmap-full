...
router
  .post(
    "/ctoclient",
    auth,
    CtoClientLogController.CadastrarCtoClientLogN,
    CtoClientController.CadastrarCtoClient
  ) // cadastra o cliente no banco
  .get("/ctoclient", auth, CtoClientController.ListarCtoClient) //lista todos os clientes no banco
  .get("/ctoclient/:cto", auth, CtoClientController.ListarCtoClientByCto) //lista todos os clientes por cto
  ...
  .post("/updatectoclient", auth, CtoClientController.UpdateCtoClientById) //recebe dados e atualiza no banco.
