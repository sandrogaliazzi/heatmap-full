...
router
  ...
  .get("/viability/:lat/:lng/:range", auth, TomodatController.CheckTomodatViability) //checa a viabilidade de portas com base na localização
  .get("/aprange/:lat/:lng/:range", auth, TomodatController.getApByRange);
