...
router
  .get("/fetch", auth, fetchController.ListarFetch) // lista o fetch do banco
  ...
  .get(
    "/fetchwithctoclientpppoe",
    auth,
    fetchController.FetchWithCtoClientsPppoe
  )
  .get(
    "/fetchwithpppoeinsideclients",
    auth,
    fetchController.FetchWithCtoClientsPppoeInsideClients
  ) //
  ...
  .get(
    "/comparefetchtopppoeanddelete",
    auth,
    fetchController.ListarFetchPppoeAndDelete
  ); // compara duas tabelas e exclui da tabela pppoe o que não existe na fetch.
