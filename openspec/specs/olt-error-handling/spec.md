# Capability: olt-error-handling

Tratamento resiliente de erros para operações de OLT/ONU, garantindo que o backend sempre encerre falhas com resposta explícita e que o frontend limpe estados pendentes e informe o usuário de forma legível.

> **Origem**: Introduzida pela change `improve-olt-error-handling`.
